    ...
    <header className="sticky top-0 z-[9999] w-full border-b border-travel-accent-gray bg-white/95 backdrop-blur-md shadow-xs">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8 gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          >
            <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-emerald-600 text-white shadow-premium">
              <svg className="h-4.5 w-4.5 transform -rotate-45" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
              </svg>
            </span>
            <span>Antigravity <span className="font-semibold text-emerald-600">Travel</span></span>
          </div>
        </div>
